...
from acoustics.room import clarity
...
fs, impulseresponse = wavfile.read('C:\TFG\Codi\masp-master\sounds\ir_centre_stalls.wav')
impulseresponse=impulseresponse[:,1]
plt.plot(impulseresponse)

rt60_Measure = revTime60(impulseresponse,band_centerfreqs,window,rt_type,oct_type,fs)
bassRatio_Measure=bass_ratio(rt60_Measure)
brightness_Measure=brightness(rt60_Measure)
c50_Measure=speechClarity50(impulseresponse,band_centerfreqs,oct_type,fs)
c80_Measure=musicClarity80(impulseresponse,band_centerfreqs,oct_type,fs)
d50_Measure=Definition(c50_Measure,band_centerfreqs)


# ACOUSTICS LIBRARY METHODS

c50_Acoustics=clarity(50.0, impulseresponse, fs, band_centerfreqs)
c80_Acoustics=clarity(80.0, impulseresponse, fs, band_centerfreqs)
d50_Acoustics=Definition(c50_Acoustics,band_centerfreqs)
